...
export const leetcodeHighlights: LeetCodeHighlight[] = [
  {
    ...
    difficulty: "Easy",
    language: "Python",
    description: "Identifies and counts all triplets in a sorted array whose consecutive elements differ by a given value.",
    upvotes: 142,
  },
  {
    ...
    difficulty: "Easy",
    language: "Java", 
    description: "Validates number of characters between each pair of same letters in a string matches a given distance array using O(n) hashmap or array lookups.",
    upvotes: 4,
  },
  {
    ...
    difficulty: "Medium",
    language: "C++",
    description: "Finds all subarrays with equal sums using a hash map for efficient O(n) solution with detailed comments.",
    upvotes: null,
  },
  {
    ...
    difficulty: "Easy",
    language: "Python",
    description: "Finds the largest positive integer that exists with its negative using a hash set for efficient O(n) solution with detailed comments.",
    upvotes: null,
  },
  {
    ...
    difficulty: "Easy",
    language: "Java",
    description: "Finds the number of distinct averages by sorting and using a hash set for efficient O(n log n) solution with detailed comments.",
    upvotes: null,
  },
  {
    ...
    difficulty: "Easy",
    language: "C++",
    description: "Finds the number of pairs whose sum is less than target using two pointers for efficient O(n log n) solution with detailed comments.",
    upvotes: null,
  },
] 